...
short Sum_Each_Row(short arr[3][3],short Rows, short Cols) {
...
void Print_Sum_Each_Row(short arr[3][3], short Rows, short Cols) {

    for (short i = 0; i < Rows; i++)
    {
        cout << "Row " << i + 1 << " Sum : ";
        cout << Sum_Each_Row(arr, i, Cols) << endl; 
    }
}
